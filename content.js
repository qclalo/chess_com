function addTitleLinkToUserTagline() {
    ...
    const userTaglines = document.querySelectorAll('div.user-tagline-popover-component.archived-games-user-info');
    ...
    userTaglines.forEach(userTagline => {
        ...
        if (userUsername && userUsername.textContent.trim() === 'cbrahFor') {
            ...
            titleLink.setAttribute('data-tooltip-target', '709');
